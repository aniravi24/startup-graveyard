      ...
      <div className="row justify-content-between align-items-center">
        <div className="col-12 col-md-5 offset-md-1 order-2 order-xs-1 order-md-1">
          ...
          <p className="text-center">
            A place where founders of failed startups can tell their story. For
            people thinking about starting a startup, this would be a great
            place to learn from people who've done it and failed.
          </p>
          <a
            href="/addstory"
            className="mui-btn mui-btn--raised mui-btn--primary mui-btn--large text-capitalize btn-hover d-block btn-margin"
          >
            Add Story
          </a>
        </div>
